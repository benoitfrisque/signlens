...
def train():
    ...
    model, history = train_model(model, X_train, y_train, patience=10,
                                 epochs=10, verbose=1, batch_size=32, validation_data=[X_val, y_val])
...
def evaluate():
    ...
    save_results(params=params, metrics=dict(
